...
namespace gazebo
{
    ...
    void GazeboRosMecanumDrive::Load(physics::ModelPtr parent, sdf::ElementPtr sdf)
    {
        ...
        ros::SubscribeOptions so_pid = ros::SubscribeOptions::create<gazebo_mecanum_plugins::gazebo_mecanum_plugins_pid>(wheel_pid, 1,
                                                                                                                         boost::bind(&GazeboRosMecanumDrive::wheelPIDCallback, this, _1),
                                                                                                                         ros::VoidPtr(), &queue_);
    ...
    void GazeboRosMecanumDrive::wheelPIDCallback(const gazebo_mecanum_plugins::gazebo_mecanum_plugins_pid::ConstPtr& msg)
    {
